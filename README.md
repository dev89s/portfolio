...
<div align="center">
  <!-- You are encouraged to replace this logo with your own! Otherwise you can also remove it. -->
    <br>
  <h1 style="font-size: 40px; color: green"><b>Portfolio</b></h1>
...
**Personal portfolio** is an example of mobile first portfolio implementation on the web. It's purpose is to demonstrate the design and technical capabilities of the developer while giving succinct information regarding past projects.
...
- **Personal representation of the owner**
...
In order to reproduce the portfolio and be able to make changes for your own purpose you need the following tools:
  - Visual Studio Code
...
### Setup
  ...
  2. Use "git" to clone this repository into your local drive:
      >```$ git clone https://github.com/dev89s/portfolio.git```

### Usage

  - To be able to see the project's current state use this command:
    > ```$ git branch checkout portfolio_setup_mobile_first```
