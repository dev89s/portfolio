...
const cardInfo = [
  {
    ...
    role: 'Full-Stack Dev',
    year: '2023',
    desctiption: "SummerWave Hotels is a website to reserve rooms for the SummerWave Hotel chains. You can select available rooms from a graphic list on the home page of the website, or you can just click on the reserve menu item and see the full list of available rooms and the city in which they are available.",
  ...
  },
  {
    ...
    role: 'Full-Stack Dev',
    year: '2023',
    desctiption: "A Web-based App that gets the weather from OpenWeather API and displays it as a list of famous cities (implemented using React/&Redux). And also uses Air Quality/Pollution API to show details of air quality for each city.",
  ...
  },
  {
    ...
    role: 'Front-End Dev',
    year: '2023',
    desctiption: "WebDev Academy is an example of a mobile-first Online Educational institution website. Its purpose is to represent the institution, its different courses, and the famous teachers from all around the world while giving the user a welcome feeling and a way to join the program.",
